...
def run_command(command, args, background, input_data):
    ...
    if command == 'exit':
        ...
        if len(args) == 1 and args[0] == "--help":
            return execute_ls.__doc__
        return execute_ls(args)
    elif command == 'mkdir':
        if len(args) == 1 and args[0] == "--help":
            return execute_mkdir.__doc__
        return execute_mkdir(args)
    elif command == 'cd':
        if len(args) == 1 and args[0] == "--help":
            return execute_cd.__doc__
        return execute_cd(args)
    elif command == 'pwd':
        if len(args) == 1 and args[0] == "--help":
            return execute_pwd.__doc__
        return execute_pwd()
    elif command == 'cp':
        if len(args) == 1 and args[0] == "--help":
            return execute_cp.__doc__
        return execute_cp(args)
    elif command == 'mv':
        if len(args) == 1 and args[0] == "--help":
            return execute_mv.__doc__
        return execute_mv(args)
    elif command == 'rm':
        if len(args) == 1 and args[0] == "--help":
            return execute_rm.__doc__
        return execute_rm(args)
    elif command == 'rmdir':
        if len(args) == 1 and args[0] == "--help":
            return execute_rmdir.__doc__
        return execute_rmdir(args)
    elif command == 'cat':
        if len(args) == 1 and args[0] == "--help":
            return execute_cat.__doc__
        return execute_cat(args)
    elif command == 'head':
        if len(args) == 1 and args[0] == "--help":
            return execute_head.__doc__
        return execute_head(args, input_data)
    elif command == 'tail':
        if len(args) == 1 and args[0] == "--help":
            return execute_tail.__doc__
        return execute_tail(args, input_data)
    elif command == 'grep':
        if len(args) == 1 and args[0] == "--help":
            return execute_grep.__doc__
        return execute_grep(args, input_data)
    elif command == 'wc':
        if len(args) == 1 and args[0] == "--help":
            return execute_wc.__doc__
